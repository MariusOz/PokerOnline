...
public class GameDTOWithoutPlayerId {
	...
	private List<PlayerDTOWithoutPlayerID> playerInfo;
	...
	public GameDTOWithoutPlayerId(int gameId, String name, ArrayList<Card> playerHand, ArrayList<Card> cardsOnTable, int totalBets,
			ArrayList<PlayerDTOWithoutPlayerID> playerInfo, PhaseEnum phase, GameStateStatusEnum status, int currentRound) {
		this.gameId = gameId;
	...
	public List<PlayerDTOWithoutPlayerID> getPlayerInfo() {
	...
	public void setPlayerInfo(List<PlayerDTOWithoutPlayerID> playerInfo) {
		this.playerInfo = playerInfo;
	}
